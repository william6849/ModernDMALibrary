...
if(WIN32)
  set(RELEASE_URL
        https://github.com/ufrisk/LeechCore/releases/download/v2.19/LeechCore_files_and_binaries_v2.19.0-win_x64-20240928.zip
  )
else()
  if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64")
    set(RELEASE_URL
        https://github.com/ufrisk/LeechCore/releases/download/v2.19/LeechCore_files_and_binaries_v2.19.0-linux_aarch64-20240928.tar.gz
    )
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "i386")
    message(WARNING "x32 platform is not support currently.")
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64")
    set(RELEASE_URL
        https://github.com/ufrisk/LeechCore/releases/download/v2.19/LeechCore_files_and_binaries_v2.19.0-linux_x64-20240928.tar.gz
    )
  endif()
endif()
